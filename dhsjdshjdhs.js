        ...
        for (; b < d; b++)
            if ((e = arguments[b]) != null)
                for (j in e) {
                    i = a[j];
                    o = e[j];
                    if (a !== o && j !== "__proto__" && j !== "constructor")
        ...
        load: function(a, b, d) {
            ...
            c.ajax({
                ...
                complete: function(i, o) {
                    ...
                    if (o === "success" || o === "notmodified") j.html(e ? c("<div />").append(removeScriptTags(i.responseText)).find(e) : i.responseText);
...
(function(f) {
    ...
    function t(a, b) {
        ...
        f.extend(c, {
            show: function(d) {
                if (!e) {
                    if (m) e = f(b.layout).addClass(b.tipClass).appendTo(document.body).hide().text(m);
...
(function(a) {
    function t(d, b) {
        ...
        var p = b.target || d.attr("rel"); /*f=p?a(p):d;*/
        f = p ? a.find(p) : d;
