...
$.fn.position = function( options ) {
	...
	options = $.extend( {}, options );
	 ...
	 if(options.of instanceof jQuery || options.of.nodeType){
		 ...
		 try{
			 document.querySelector(options.of);
		 }catch(e){
...
let elements = [];
       ...
       try {
        elements = Array.from(document.querySelectorAll(altField));
        if (elements.length === 0) {
          console.warn("No elements matched altField selector:", altField);
          return;
        }
      } catch (e) {
        console.warn("Error parsing altField selector:", altField);
        return;
      }
