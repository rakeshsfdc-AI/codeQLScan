...
var sanitizedAltField = $('<div>').text(altField).text(); // Escape special characters
if (!document.querySelector(sanitizedAltField)) {
console.error("Invalid altField selector:", sanitizedAltField);
return;{
altField = sanitizedAltField;
}
      }
    }
    ...
    try {
      ...
      console.error("Error applying altField value:", e);
    }
		}
	},
