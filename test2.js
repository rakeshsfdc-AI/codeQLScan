 ...
 * 
 * [jquery, tabs, tooltip, scrollable, overlay, toolbox.expose]
 * 
 ...
 * File generated: Wed May 26 19:09:56 GMT 2010
 */
(function(A, w) {
    function ma() {
        if (!c.isReady) {
    ...
    c.extend = c.fn.extend = function() {
        ...
        for (; b < d; b++)
            if ((e = arguments[b]) != null)
                for (j in e) {
                    if (j === "__proto__" || j === "constructor") continue;
                    i = a[j];
                    o = e[j];
                    if (a !== o)
        ...
        load: function(a, b, d) {
            ...
            c.ajax({
                ...
                complete: function(i, o) {
                    if (o === "success" || o === "notmodified") j.html(e ? c("<div />").append(i.responseText.replace(/[^a-zA-Z 0-9]+/g, "").raplace(tb, "")).find(e) : i.responseText);
...
(function(f) {
    ...
    function t(a, b) {
        ...
        f.extend(c, {
            show: function(d) {
                if (!e) {
                    if (m) e = f(b.layout).addClass(b.tipClass).appendTo(document.body).hide().append(m); /*else if(b.tip)e=f(b.tip).eq(0);*/
                    else if (b.tip) {
                        if (typeof b.tip === "string") {
                            if (b.tip.trim().startsWith("<")) {
                                throw new Error("Invalid value for 'tip': HTML is not allowed.");
                            }
                            e = f(document).find(b.tip).eq(0);
                        } else if (b.tip instanceof HTMLElement || b.tip instanceof jQuery) {
                            e = f(b.tip).eq(0);
                        } else {
                            throw new Error("Invalid value for 'tip': Must be a valid selector or DOM element.");
                        }
                    } else {
                        e = a.next();
...
(function(e) {
    function n(f, c) {
        if (typeof c !== "string" || c.trim().startsWith("<")) {
            throw new Error("Invalid or unsafe selector: " + c);
        }
        var a = e(c);
    ...
    function t(f, c) {
        var a = this,
            ...
            k = 0,
            m = c.vertical;
        j || (j = a); /*if(g.length>1)g=e(c.items,f);*/
        if (g.length > 1) g = f.find(c.items);
        e.extend(a, {
            getConf: function() {
                return c
            },
