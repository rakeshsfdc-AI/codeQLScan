	...
	clean: function( elems, context, fragment, scripts ) {
		...
		for ( i = 0; (elem = elems[i]) != null; i++ ) {
			...
			if ( typeof elem === "string" ) {
				if ( !rhtml.test( elem ) ) {
					...
					elem = expandSelfClosingTags(elem);
		...
		function expandSelfClosingTags(html){
			...
			parser.end();
			 ...
			 const expandedHtml = htmlparser2.DomUtils.getOuterHTML(dom);
			 return expandedHtml;
		}
	...
	jQuery.ajax({
		...
		self.html( selector ?
			...
			jQuery("<div>")
				...
				.append((function sanitizeResponseText(text){
					let previous ;
					do{
						previous = text;
