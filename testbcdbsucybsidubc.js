...
$.extend(Datepicker.prototype, {
	...
	_updateAlternate: function(inst) {
       ...
       var sanitizedAltField = null; //Sanitize altField to prevent potential XSS
        sanitizedAltField = $(altField).length ? altField : $('<div>').text(altField).text(); // Ensure valid selector or escape special characters		
		try{
