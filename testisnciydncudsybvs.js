...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(input, inst) {
		...
		if (appendText) {
			...
			var escapedAppendText = $('<div>').text(appendText).html();
			inst.append =  $('<span class="' + this._appendClass + '">' + escapedAppendText + '</span>');
	...
	_updateAlternate: function(inst) {
		...
		//Validate altField to ensure it is a valid selector or DOM element
		 if (typeof altField === 'string') {
            // Only allow safe CSS selectors (IDs or class names)
            if (!/^#?[\w-]+$/.test(altField)) {
                this.log("Error: altField string is not a safe CSS selector.");
                return;
            }
